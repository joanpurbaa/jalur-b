...
export default function HowItWorks() {
	return (
		<section id="cara-kerja" className="mx-auto px-5 sm:px-10 lg:px-20 xl:px-32 2xl:px-72 py-32 lg:py-40">
			<Reveal>
			...
			<ol className="mt-24 hidden grid-cols-1 gap-y-14 lg:grid lg:grid-cols-4 lg:gap-x-10 lg:gap-y-0">
			...
			<ol className="mt-20 grid grid-cols-1 gap-y-12 lg:hidden">
				{STEPS.map((step, index) => (
					...
					<li
						...
						<h3 className="mt-5 text-lg font-bold text-neutral">{step.title}</h3>
